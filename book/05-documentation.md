...
the onboarding ramp for users and contributors alike.

People discovering your software need to know essential information. In this
chapter I suggest the creation of many different documents with specific
information. Sometimes it makes sense to condense certain documents into the
README file, sometimes it’s better to keep them separate and link to them from
your landing page. However you decide to organize the documentation for your
project, the README file should have content or links for the following:
...
* Usage examples
* Running tests
* High-level overview of the software
* API documentation
* License
* Contributing

The mission statement should be short and concrete. You can assume a minimally
informed reader, as someone who doesn’t know what key concepts used by your
project mean probably won’t make much sense of the rest of the document anyway.
After reading your mission statement users for your library should be well
informed about how useful will the project be to his problem, helping them take
...
that they have a problem. If you know about persistent issues, such as resolving
a dependency, call that out in a section of its own and provide a solution or
workaround. A great example of one such issue is [thoughtbot/capybara-webkit’s]
...
[thoughtbot/capybara-webkit’s]: https://github.com/thoughtbot/capybara-webkit
[added a notice]: https://github.com/thoughtbot/capybara-webkit#qt-dependency-and-installation-issues

Help people like, use or contribute to your software with a welcoming,
informative landing page.


## Overview

Imagine you have found a project you find good for your goals, and want to see
in more specific detail if you can make it work, and make some configurations.
You will get questions like: “what are the bigger modules for this software?”,
...
instead get a more general view of the architecture. That’s what the Overview
document shows.

The overview doesn’t need to show every file or subdirectory of your project,
only the most important concepts. You shouldn’t assume though that what one
script does, or how the files in a directory interact, or where
to find a piece of code is always clear to a newcomer. Making such assumptions
makes _you_ the onboarding bottleneck, as you will personally need to answer
questions, and you will not always be as readily available as documents
...
you through the paths that are in need of more clarification for your userbase.

If you use other libraries, the Overview document is a good place to link to
their documentation too.

Two good Overview document examples:
...
Every step needed for the project to run on a new computer are explained in the
Installing document. It details how to find, install, compile, require, link,
insert, and import and export its dependencies in the supported environments.
...
should set up dependencies and run tests to make sure the project is correctly
set up and ready to be worked on.

The first section should detail how to run the automated setup script, so that in no
...
software project, because even people with intention, skills and curiosity to
...
Imagine a user upgrading your project’s version in their software. They will
want to know what is new: what is changed from version X to Y? What are new
...
but the file needs a simple basis of what is to be expected from each member.
...
better to proactively put policies in place because it deals with people, and
...
specify you might include follow:
...
(“black hats”) from exploiting vulnerabilities before they are fixed. We’ll
speak more about security considerations in the “Releasing” chapter of this
book.

GitHub acknowledges the existence of a CONTRIBUTING or CONTRIBUTING.md file in
the root path of the repository, and adds a link to it when a contributor sees
...
accompanying script specifying in code the human description.
...
versioned and tested as code is. You will want to curate it as much as you do
...
your users think more than they need.
